...
class UserForm(forms.ModelForm):
    ...
    password = forms.CharField(required=True, min_length=8, widget=forms.PasswordInput(attrs={'class' : 'uk-input uk-width-1-2', 'style' : 'width: 100%; margin: 20px 0px; border-radius: 10px;'}))
